...
/// {
///     window.InitWindowSize(1280, 720);
/// });
/// ]]></code>
/// </example>
public interface IFlourishWindowPropertyBuilder
{
    ...
    /// <example>
    /// <code><![CDATA[
    /// window.InitWindowMinSize(1280, 720);
    /// ]]></code>
    /// </example>
    IFlourishWindowPropertyBuilder InitWindowMinSize(double minWidth = 1280, double minHeight = 720);
    ...
    /// <example>
    /// <code><![CDATA[
    /// window.InitWindowMaxSize(1920, 1080);
    /// ]]></code>
    /// </example>
    IFlourishWindowPropertyBuilder InitWindowMaxSize(
    ...
    /// <example>
    /// <code><![CDATA[
    /// window.InitWindowPosition(WindowStartupLocation.CenterScreen);
    /// ]]></code>
    /// </example>
    ...
    /// <example>
    /// <code><![CDATA[
    /// window.InitWindowResizeMode(ResizeMode.CanResize);
    /// ]]></code>
    /// </example>
    IFlourishWindowPropertyBuilder InitWindowResizeMode(ResizeMode resizeMode = ResizeMode.CanResize);
    ...
    /// <example>
    /// <code><![CDATA[
    /// window.InitShownInTaskbar(true);
    /// ]]></code>
    /// </example>
    IFlourishWindowPropertyBuilder InitShownInTaskbar(bool enabled = true);
