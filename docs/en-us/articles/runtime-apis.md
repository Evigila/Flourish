...
| `IFontService` | Change the global text family, icon family, and base size independently or with `SetFont`; inspect, set, and clear page-specific overrides through `PageOverrides`, `SetOverrideFont`, and `ClearOverrideFont`. |
