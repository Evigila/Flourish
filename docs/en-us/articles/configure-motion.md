...
`UseHoverRevealAnimation` enables hover animation on supported controls, including the Button family, selection-item containers, and the closed ComboBox selector.
