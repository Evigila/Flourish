...
`UseGlobalFont` 可以统一设置 Flourish Shell 框架的字体系列和基础字号。它会影响标题栏、导航栏、动态工具栏、状态栏和 Shell 对话框；应用页面仍可使用自己的 WPF 样式。
...
`UseGlobalFont` 只设置 Shell 框架的基础排版。页面、图表或需要特殊层级的内容可以继续通过资源字典和局部样式设置字体。
